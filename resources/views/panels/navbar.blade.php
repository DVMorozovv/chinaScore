...
{{--      </div>--}}
      <ul class="navbar-list right">
          ...
          @else
              <li>
                  <a class="waves-effect waves-block waves-light translation-button" href="#!" data-target="dropdown1">{{ Auth::user()->name }}
...
{{--        </li>--}}
        ...
        <ul id="dropdown1" class="dropdown-content">
            <li class="dropdown-item">
                <a class="grey-text text-darken-1" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">{{ __('Выйти') }}</a>
