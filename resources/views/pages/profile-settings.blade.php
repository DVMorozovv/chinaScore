                            ...
                            <div class="row">
                                <div class="col s12">
                                    <div class="input-field">
                                        ...
                                        <input type="text" id="uname" name="uname" value="{{ Auth::user()->name }}" data-error=".errorTxt1">
...
{{--                                </div>--}}
                                <div class="col s12">
                                    <div class="input-field">
                                        ...
                                        <input id="email" type="email" name="email" value="{{ Auth::user()->email }}" data-error=".errorTxt3">
