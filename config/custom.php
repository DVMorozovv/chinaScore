...
return [
    'custom' => [
        ...
        'navbarBgColor' => 'gradient-45deg-purple-deep-orange', //Options: cyan,teal,light-blue,amber (any of materializecolor class can be pass). warning:if isNavbarDark set NavbarBgColor not work.
        ...
        'activeMenuColor' => 'gradient-45deg-purple-deep-orange', //Sidebar active menu color (any of materializecolor class can be pass)
        ...
        'templateTitle' => 'ChinaScore', //template Title can be changes default('Materialize)
        ...
        'largeScreenLogo' => 'images/logo/materialize-logo.png', //we used saparete log image for large screen and small
